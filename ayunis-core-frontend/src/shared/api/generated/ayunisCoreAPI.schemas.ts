...
export interface TrialStatusDto {
  ...
  updatedAt: string;
  /** Organization ID associated with the trial */
  orgId: string;
  /** Number of messages sent during the trial */
  messagesSent: number;
...
/**
 * Trial information if no active subscription exists
 * @nullable
 */
export type SubscriptionStatusResponseDtoTrial = TrialStatusDto | null;
...
export interface SubscriptionStatusResponseDto {
   ...
   * @nullable
   */
  trial?: SubscriptionStatusResponseDtoTrial;
}
