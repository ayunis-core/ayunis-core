...
export const subscriptionsControllerGetStatus = (
 ...
 signal?: AbortSignal
      ...
      return customAxiosInstance<SubscriptionStatusResponseDto>(
      {url: `/subscriptions/status`, method: 'GET', signal
    },
      );
    }
...
export const getSubscriptionsControllerGetStatusQueryKey = () => {
    return [
...
export const getSubscriptionsControllerGetStatusQueryOptions = <TData = Awaited<ReturnType<typeof subscriptionsControllerGetStatus>>, TError = unknown>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof subscriptionsControllerGetStatus>>, TError, TData>>, }
) => {

const {query: queryOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getSubscriptionsControllerGetStatusQueryKey();

  

    const queryFn: QueryFunction<Awaited<ReturnType<typeof subscriptionsControllerGetStatus>>> = ({ signal }) => subscriptionsControllerGetStatus(signal);

      

      

   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof subscriptionsControllerGetStatus>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type SubscriptionsControllerGetStatusQueryResult = NonNullable<Awaited<ReturnType<typeof subscriptionsControllerGetStatus>>>
export type SubscriptionsControllerGetStatusQueryError = unknown


export function useSubscriptionsControllerGetStatus<TData = Awaited<ReturnType<typeof subscriptionsControllerGetStatus>>, TError = unknown>(
  options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof subscriptionsControllerGetStatus>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof subscriptionsControllerGetStatus>>,
          TError,
          Awaited<ReturnType<typeof subscriptionsControllerGetStatus>>
        > , 'initialData'
      >, }
...
export function useSubscriptionsControllerGetStatus<TData = Awaited<ReturnType<typeof subscriptionsControllerGetStatus>>, TError = unknown>(
  options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof subscriptionsControllerGetStatus>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary Get subscription/trial status for UI gating
...
export function useSubscriptionsControllerGetStatus<TData = Awaited<ReturnType<typeof subscriptionsControllerGetStatus>>, TError = unknown>(
 ...
 , queryClient?: QueryClient 
  ...
  const queryOptions = getSubscriptionsControllerGetStatusQueryOptions(options)
