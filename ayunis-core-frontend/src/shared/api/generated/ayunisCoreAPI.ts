 ...
 */
export const creditLimitsControllerGetOverview = (
    
 signal?: AbortSignal
) => {
      
      
      return customAxiosInstance<CreditLimitsOverviewResponseDto>(
      {url: `/credit-limits`, method: 'GET', signal
    },
      );
    }
...
export const getCreditLimitsControllerGetOverviewQueryKey = () => {
    return [
    `/credit-limits`
    ] as const;
    }
...
export const getCreditLimitsControllerGetOverviewQueryOptions = <TData = Awaited<ReturnType<typeof creditLimitsControllerGetOverview>>, TError = unknown>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof creditLimitsControllerGetOverview>>, TError, TData>>, }
) => {

const {query: queryOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getCreditLimitsControllerGetOverviewQueryKey();

  

    const queryFn: QueryFunction<Awaited<ReturnType<typeof creditLimitsControllerGetOverview>>> = ({ signal }) => creditLimitsControllerGetOverview(signal);

      

      

   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof creditLimitsControllerGetOverview>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type CreditLimitsControllerGetOverviewQueryResult = NonNullable<Awaited<ReturnType<typeof creditLimitsControllerGetOverview>>>
export type CreditLimitsControllerGetOverviewQueryError = unknown


export function useCreditLimitsControllerGetOverview<TData = Awaited<ReturnType<typeof creditLimitsControllerGetOverview>>, TError = unknown>(
  options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof creditLimitsControllerGetOverview>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof creditLimitsControllerGetOverview>>,
          TError,
          Awaited<ReturnType<typeof creditLimitsControllerGetOverview>>
        > , 'initialData'
      >, }
...
export function useCreditLimitsControllerGetOverview<TData = Awaited<ReturnType<typeof creditLimitsControllerGetOverview>>, TError = unknown>(
  options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof creditLimitsControllerGetOverview>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary List configured credit limits with current consumption
...
export function useCreditLimitsControllerGetOverview<TData = Awaited<ReturnType<typeof creditLimitsControllerGetOverview>>, TError = unknown>(
 ...
 , queryClient?: QueryClient 
  ...
  const queryOptions = getCreditLimitsControllerGetOverviewQueryOptions(options)
...
export const creditLimitsControllerSetUserLimit = (
    ...
    setCreditLimitDto: SetCreditLimitDto,
      ...
      return customAxiosInstance<CreditLimitResponseDto>(
