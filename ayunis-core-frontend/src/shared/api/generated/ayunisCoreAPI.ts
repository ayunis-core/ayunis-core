...
if(threadSourcesControllerAddFileSourceBody.name !== undefined) {
 formData.append(`name`, threadSourcesControllerAddFileSourceBody.name)
 }
if(threadSourcesControllerAddFileSourceBody.description !== undefined) {
 formData.append(`description`, threadSourcesControllerAddFileSourceBody.description)
 }
