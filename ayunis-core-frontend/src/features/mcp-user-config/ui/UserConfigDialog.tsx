...
function hasUserLevelOAuth(
  ...
  if (!integration.oauth || typeof integration.oauth !== 'object') {
    return false;
  }

  const oauth = integration.oauth as Record<string, unknown>;

  return oauth.enabled === true && oauth.level === 'user';
}
