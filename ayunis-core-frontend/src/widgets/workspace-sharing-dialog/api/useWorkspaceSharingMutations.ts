...
import {
  ...
  useWorkspaceMembersControllerUpdateRole,
  ...
  useWorkspaceTeamGrantsControllerUpdateRole,
...
export function useUpdateWorkspaceMemberRole(workspaceId: string) {
  return useWorkspaceMembersControllerUpdateRole({
    mutation: useSharingMutationFeedback(workspaceId),
  });
}
...
export function useUpdateWorkspaceTeamGrantRole(workspaceId: string) {
  return useWorkspaceTeamGrantsControllerUpdateRole({
    mutation: useSharingMutationFeedback(workspaceId),
  });
}
