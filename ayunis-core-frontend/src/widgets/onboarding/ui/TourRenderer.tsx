...
export default function TourRenderer({
  ...
  const { Tour } = useJoyride({
    ...
    options: {
      ...
      spotlightRadius,
      skipBeacon: true,
      // How long joyride waits for the target node before giving up and firing
      // TARGET_NOT_FOUND (→ onEnd). Unrelated to per-target settleMs; this is
      // what keeps a never-appearing target from wedging the tour open.
