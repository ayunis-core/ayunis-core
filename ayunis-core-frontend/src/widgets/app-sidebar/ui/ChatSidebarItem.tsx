...
import {
  useAssignThreadToWorkspace,
  useToggleThreadPinned,
  useWorkspaces,
    ...
    <>
      <SidebarMenuItem data-testid="chat">
        ...
        <DropdownMenu>
          ...
          >
            <DropdownMenuItem
              onClick={() => onRename(thread.id, thread.title ?? null)}
              data-testid="rename"
            >
              <Pencil />
            ...
            {isWorkspacesEnabled && (
              <>
                <DropdownMenuItem onClick={() => togglePinned(thread.id)}>
                  <Star
                    className={cn(thread.isPinned && 'fill-brand text-brand')}
                  />
                  <span>
                    {thread.isPinned
                      ? t('sidebar.unpinChat')
