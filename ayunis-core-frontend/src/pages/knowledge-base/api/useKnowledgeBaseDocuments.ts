import { useKnowledgeBaseDocumentsControllerListDocuments } from '@/shared/api/generated/ayunisCoreAPI';
...
export function useKnowledgeBaseDocuments(id: string) {
  const { data, isLoading } = useKnowledgeBaseDocumentsControllerListDocuments(
    id,
    {
      query: {
        staleTime: 0,
