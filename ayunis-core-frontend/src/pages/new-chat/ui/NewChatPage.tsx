...
import { useSampleAttachment } from '../model/useSampleAttachment';
...
export default function NewChatPage({
  ...
  // Attach the prefilled sample file (if any) once it has downloaded.
  useSampleAttachment(initialAttachmentUrl, (file) => handleFileUpload([file]));
