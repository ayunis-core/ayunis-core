...
export function WorkspaceContextSidePanel({
  ...
  return (
    <aside
      ...
      data-testid="workspace-context-side-panel"
    >
      <div className="flex items-center justify-between border-b px-3 py-2">
        ...
        <div className="flex items-center gap-1">
          <Button
            variant="ghost"
            size="icon"
            data-testid="workspace-context-side-panel-close"
            onClick={onClose}
...
function InstructionsPanel({
  ...
  return (
    <p
      className="whitespace-pre-wrap rounded-md border bg-muted/30 p-3 text-sm leading-relaxed text-muted-foreground"
      data-testid="workspace-context-instruction-text"
    >
      {context.instruction}
    </p>
  );
...
function PanelItem({
  ...
  return (
    <Item
      variant="outline"
      size="sm"
      data-testid="workspace-context-panel-item"
    >
