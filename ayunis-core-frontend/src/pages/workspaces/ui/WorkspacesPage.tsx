...
import { useWorkspacesViewMode } from './useWorkspacesViewMode';
...
export default function WorkspacesPage({
  ...
  const [viewMode, setViewMode] = useWorkspacesViewMode();
      ...
      <ContentAreaLayout
        ...
        contentArea={
          <div className="space-y-4">
            ...
            <WorkspacesContent workspaces={visible} viewMode={viewMode} />
          </div>
        }
      />
      {createDialog}
