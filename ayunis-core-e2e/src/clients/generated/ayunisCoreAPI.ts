 ...
 */
const skillsControllerFindInstalledFromMarketplace = (
    identifier: string,
 options?: SecondParameter<typeof playwrightApiClient<InstalledMarketplaceSkillResponseDto>>,) => {
      return playwrightApiClient<InstalledMarketplaceSkillResponseDto>(
      {url: `/skills/marketplace/${identifier}`, method: 'GET'
    },
      options);
    }
