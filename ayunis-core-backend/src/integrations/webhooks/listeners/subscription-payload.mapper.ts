...
export function mapSubscriptionToWebhookPayload(
  ...
  if (data.type === SubscriptionType.SEAT_BASED) {
    ...
    return {
      ...base,
      type: 'SEAT_BASED',
      noOfSeats: seatData.noOfSeats,
      pricePerSeat: seatData.pricePerSeat,
      renewalCycle: seatData.renewalCycle,
      renewalCycleAnchor: seatData.renewalCycleAnchor.toISOString(),
