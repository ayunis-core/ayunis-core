...
export class InvitesController {
  ...
  async getInvites(
    ...
    const paginatedInvites = await this.getInvitesByOrgUseCase.execute(
    ...
    return this.inviteResponseMapper.toListDto(paginatedInvites);
  }
