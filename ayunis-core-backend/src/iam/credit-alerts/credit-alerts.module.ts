...
import { BudgetAlertNotificationRecord } from './infrastructure/persistence/local/schema/budget-alert-notification.record';
...
import { BudgetAlertsTask } from './infrastructure/tasks/budget-alerts.task';

@Module({
  imports: [
    TypeOrmModule.forFeature([BudgetAlertNotificationRecord]),
    OrgsModule,
    UsersModule,
    SubscriptionsModule,
    CreditLimitsModule,
