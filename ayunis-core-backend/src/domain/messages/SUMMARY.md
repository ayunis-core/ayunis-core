...
- **AssistantMessageCreatedEvent** (`message.assistant-created`) — Emitted when an assistant message is created. Carries userId, orgId, threadId, and messageId.
- **UserMessageCreatedEvent** (`message.user-created`) — Emitted when a user message is created. Carries userId, orgId, threadId, and messageId.
