...
import type { KnowledgeBaseShare } from 'src/domain/shares/domain/share.entity';
...
describe('KnowledgeBaseAccessService', () => {
  ...
  describe('findAllAccessible', () => {
    ...
    it('should return shared KBs with isShared=true', async () => {
      ...
      const share = { knowledgeBaseId: sharedKbId } as KnowledgeBaseShare;
    ...
    it('should deduplicate owned vs shared KBs', async () => {
      const kb = makeKb();
      const share = { knowledgeBaseId: kbId } as KnowledgeBaseShare;
