import { UpdateWorkspaceKnowledgeBaseUseCase } from './update-workspace-knowledge-base.use-case';
...
import { UpdateWorkspaceKnowledgeBaseUseCase as Operation } from 'src/domain/knowledge-bases/application/use-cases/update-workspace-knowledge-base/update-workspace-knowledge-base.use-case';
...
describe(UpdateWorkspaceKnowledgeBaseUseCase.name, () => {
