import { SetWorkspaceSkillActivationUseCase } from './set-workspace-skill-activation.use-case';
...
import { SetWorkspaceSkillActivationUseCase as Operation } from 'src/domain/skills/application/use-cases/set-workspace-skill-activation/set-workspace-skill-activation.use-case';
...
async function setup() {
  ...
  const command = { ...fixture.skillQuery, isActive: false };
  return {
    ...fixture,
    operation,
    command,
...
describe(SetWorkspaceSkillActivationUseCase.name, () => {
