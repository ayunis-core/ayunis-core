...
import { CopyPersonalKnowledgeBaseToWorkspaceUseCase } from 'src/domain/workspaces/application/use-cases/copy-personal-knowledge-base-to-workspace/copy-personal-knowledge-base-to-workspace.use-case';
import { CopyPersonalKnowledgeBaseToWorkspaceCommand } from 'src/domain/workspaces/application/use-cases/copy-personal-knowledge-base-to-workspace/copy-personal-knowledge-base-to-workspace.command';
...
import { CopyPersonalKnowledgeBaseDto } from 'src/domain/workspaces/presenters/http/dtos/copy-personal-knowledge-base.dto';
import {
...
export class WorkspaceContextController {
  constructor(
    ...
    private readonly copyPersonalKnowledgeBaseToWorkspaceUseCase: CopyPersonalKnowledgeBaseToWorkspaceUseCase,
  ...
  @Post('knowledge-bases/copies')
  @ApiResponse({ status: 201, type: WorkspaceKnowledgeBaseResponseDto })
  async copyPersonalKnowledgeBase(
    @Param('id', ParseUUIDPipe) id: UUID,
    @Body() dto: CopyPersonalKnowledgeBaseDto,
  ): Promise<WorkspaceKnowledgeBaseResponseDto> {
    const knowledgeBase =
      await this.copyPersonalKnowledgeBaseToWorkspaceUseCase.execute(
        new CopyPersonalKnowledgeBaseToWorkspaceCommand(
          id,
          dto.knowledgeBaseId,
        ),
      );
