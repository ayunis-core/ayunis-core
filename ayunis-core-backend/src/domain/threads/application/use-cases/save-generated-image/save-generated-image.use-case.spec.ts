...
describe('SaveGeneratedImageUseCase', () => {
  ...
  describe('execute', () => {
    ...
    it('should throw UnsupportedImageContentTypeError for unsupported content types without uploading or persisting', async () => {
      ...
      expect(generatedImagesRepository.save).not.toHaveBeenCalled();
    });
  });
});
