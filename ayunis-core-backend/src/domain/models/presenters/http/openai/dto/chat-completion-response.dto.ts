...
export class ChatCompletionMessageResponseDto {
  ...
  @ApiProperty({
    nullable: true,
    description:
      'Refusal message generated by the model. Always null on this endpoint.',
  })
  refusal: string | null;
...
export class ChatCompletionChoiceResponseDto {
  ...
  @ApiProperty({
    nullable: true,
    description:
      'Log probability information for the choice. Always null on this endpoint.',
  })
  logprobs: null;

  @ApiProperty({ enum: ['stop', 'length', 'tool_calls'] })
