...
- **MapMessagesToInferenceUseCase** (`application/use-cases/map-messages-to-inference`): Converts backend thread messages into provider-agnostic inference messages for consumers outside the models module.
