  ...
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."models_provider_enum" AS ENUM('openai', 'anthropic', 'bedrock', 'mistral', 'ollama', 'synaforce', 'ayunis', 'otc', 'azure', 'gemini', 'stackit')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."usage_provider_enum" AS ENUM('openai', 'anthropic', 'bedrock', 'mistral', 'ollama', 'synaforce', 'ayunis', 'otc', 'azure', 'gemini', 'stackit')`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."usage_provider_enum_old" AS ENUM('anthropic', 'ayunis', 'azure', 'bedrock', 'gemini', 'mistral', 'ollama', 'openai', 'otc', 'synaforce')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."models_provider_enum_old" AS ENUM('anthropic', 'ayunis', 'azure', 'bedrock', 'gemini', 'mistral', 'ollama', 'openai', 'otc', 'synaforce')`,
    );
    await queryRunner.query(
