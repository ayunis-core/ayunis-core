...
export class CreateArtifactsTables1771487387818 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."agent_tools_tooltype_enum_old" AS ENUM('activate_skill', 'bar_chart', 'code_execution', 'create_calendar_event', 'create_skill', 'http', 'internet_search', 'line_chart', 'mcp_prompt', 'mcp_resource', 'mcp_tool', 'pie_chart', 'product_knowledge', 'send_email', 'source_get_text', 'source_query', 'website_content')`);
