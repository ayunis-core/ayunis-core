...
export class FixSchemaDrift1776162477472 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."UQ_marketplace_org_identifier"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_2d4c91a8c18766bbbcba842d07" ON "permitted_models" ("scope_id", "modelId") WHERE "scope" = 'team'`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_63afa79e56fd0523bc7f8f1a30" ON "mcp_integrations" ("orgId", "marketplace_identifier") WHERE "marketplace_identifier" IS NOT NULL`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_d5214d1c8a5cb55639fc05e33a" ON "skill_templates" ("distributionMode") `,
    );
    await queryRunner.query(
      `ALTER TABLE "permitted_models" ADD CONSTRAINT "FK_67e70e76f8ac05331cc49032517" FOREIGN KEY ("scope_id") REFERENCES "teams"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "mcp_integration_user_configs" ADD CONSTRAINT "FK_d3a56555dd20f2c0af66c10959c" FOREIGN KEY ("integration_id") REFERENCES "mcp_integrations"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "mcp_integration_user_configs" DROP CONSTRAINT "FK_d3a56555dd20f2c0af66c10959c"`,
    );
    await queryRunner.query(
      `ALTER TABLE "permitted_models" DROP CONSTRAINT "FK_67e70e76f8ac05331cc49032517"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_d5214d1c8a5cb55639fc05e33a"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_63afa79e56fd0523bc7f8f1a30"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_2d4c91a8c18766bbbcba842d07"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_605f8ca2a5a7123c96c2f145a2" ON "permitted_models" ("modelId", "scope_id") WHERE (scope = 'team'::permitted_models_scope_enum)`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "mcp_integration_user_configs" ADD CONSTRAINT "FK_user_config_integration" FOREIGN KEY ("integration_id") REFERENCES "mcp_integrations"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
