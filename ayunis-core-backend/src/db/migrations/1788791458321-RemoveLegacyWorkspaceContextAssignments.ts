...
export class RemoveLegacyWorkspaceContextAssignments1788791458321 implements MigrationInterface {
  name = 'RemoveLegacyWorkspaceContextAssignments1788791458321';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await this.createSourceAssignments(queryRunner);
    await this.createSkillAssignments(queryRunner);
    await this.createKnowledgeBaseAssignments(queryRunner);
  }

  private async createSourceAssignments(queryRunner: QueryRunner) {
    await queryRunner.query(
  ...
  private async createSkillAssignments(queryRunner: QueryRunner) {
    await queryRunner.query(
  ...
  private async createKnowledgeBaseAssignments(queryRunner: QueryRunner) {
    await queryRunner.query(
