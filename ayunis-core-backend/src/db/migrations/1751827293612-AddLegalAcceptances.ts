...
export class AddLegalAcceptances1751827293612 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."legal_acceptances_modelprovider_enum" AS ENUM('openai', 'anthropic', 'mistral')`,
    );
    await queryRunner.query(
      `CREATE TABLE "legal_acceptances" ("id" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "version" character varying NOT NULL, "userId" character varying NOT NULL, "orgId" character varying NOT NULL, "type" character varying NOT NULL, "modelProvider" "public"."legal_acceptances_modelprovider_enum", CONSTRAINT "PK_80ba27e822e932eceb3b0640983" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_f62debcd26469d1afe5e4dff49" ON "legal_acceptances" ("type") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."models_provider_enum" AS ENUM('openai', 'anthropic', 'mistral')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."permitted_providers_provider_enum" AS ENUM('openai', 'anthropic', 'mistral')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "legal_acceptances" ADD CONSTRAINT "FK_6c761f5968c323c7c348628093c" FOREIGN KEY ("orgId") REFERENCES "orgs"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "legal_acceptances" DROP CONSTRAINT "FK_6c761f5968c323c7c348628093c"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."permitted_providers_provider_enum_old" AS ENUM('openai', 'anthropic', 'mistral', 'microsoft', 'ollama')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."models_provider_enum_old" AS ENUM('openai', 'anthropic', 'mistral', 'microsoft', 'ollama')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_f62debcd26469d1afe5e4dff49"`,
    );
