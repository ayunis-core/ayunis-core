...
export class AddExclusiveWorkspaceResourceOwnership1788262583159 implements MigrationInterface {
    name = 'AddExclusiveWorkspaceResourceOwnership1788262583159'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "knowledge_bases" DROP CONSTRAINT "FK_e7f0bbc4c652f1c9146114c1b46"`);
        await queryRunner.query(`ALTER TABLE "knowledge_bases" ALTER COLUMN "userId" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "skills" DROP CONSTRAINT "FK_ee1265e76ea0b8c5f7daa85e817"`);
        await queryRunner.query(`ALTER TABLE "skills" ALTER COLUMN "userId" DROP NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "knowledge_bases" ADD CONSTRAINT "CHK_knowledge_bases_exactly_one_owner" CHECK (("userId" IS NOT NULL AND "workspaceId" IS NULL) OR ("userId" IS NULL AND "workspaceId" IS NOT NULL))`);
        await queryRunner.query(`ALTER TABLE "skills" ADD CONSTRAINT "CHK_skills_exactly_one_owner" CHECK (("userId" IS NOT NULL AND "workspaceId" IS NULL) OR ("userId" IS NULL AND "workspaceId" IS NOT NULL))`);
        await queryRunner.query(`ALTER TABLE "knowledge_bases" ADD CONSTRAINT "FK_e7f0bbc4c652f1c9146114c1b46" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "knowledge_bases" DROP CONSTRAINT "FK_e7f0bbc4c652f1c9146114c1b46"`);
        await queryRunner.query(`ALTER TABLE "skills" DROP CONSTRAINT "CHK_skills_exactly_one_owner"`);
        await queryRunner.query(`ALTER TABLE "knowledge_bases" DROP CONSTRAINT "CHK_knowledge_bases_exactly_one_owner"`);
        ...
        await queryRunner.query(`ALTER TABLE "skills" ALTER COLUMN "userId" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "skills" ADD CONSTRAINT "FK_ee1265e76ea0b8c5f7daa85e817" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "knowledge_bases" ALTER COLUMN "userId" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "knowledge_bases" ADD CONSTRAINT "FK_e7f0bbc4c652f1c9146114c1b46" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
