...
export class CreateCreditLimitsTable1782832474705 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_59f2519572695fd0b5d9e67eb1" ON "credit_limits" ("org_id", "target_team_id") WHERE "target_team_id" IS NOT NULL`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_62e9fb8fb97491b589773135b1" ON "credit_limits" ("org_id", "target_user_id") WHERE "target_user_id" IS NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_62e9fb8fb97491b589773135b1"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_59f2519572695fd0b5d9e67eb1"`,
    );
